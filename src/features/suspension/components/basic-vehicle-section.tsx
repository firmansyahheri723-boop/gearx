		...
		<div class="border border-border/50 bg-background/50">
					...
					>
						<div class="flex items-center">
							<NumberInput
								...
								onChange={(val) =>
									setVehicleInputs("frontWeightDistribution", val)
								}
								step={0.1}
								class="flex-1 px-3 py-2 bg-transparent text-foreground-secondary focus:outline-none focus:text-emerald-400"
							/>
					...
					<tr>
						...
						<td class="border-b border-border/50 p-0 bg-surface-elevated/40">
							<RangeSliderInput
								...
								onChange={(val) =>
									setVehicleInputs("desiredRideFrequency", val)
								}
								minLabel="3"
								maxLabel="5"
			...
			<div class="block sm:hidden space-y-3 p-3">
				...
				<div class="space-y-1">
					<div class="flex items-center justify-between">
						<label
							for="mobile-ride-freq"
							class="block text-xs uppercase tracking-wide text-foreground-secondary"
						>
							Ride frequency
						</label>
						<span class="text-sm text-foreground-secondary">
							{vehicleInputs.desiredRideFrequency.toFixed(decimals(0.1))} Hz
						</span>
					</div>
					<RangeSliderInput
						min={3}
				...
				<div class="space-y-1">
					<div class="flex items-center justify-between">
						<label
							for="mobile-roll-grad"
							class="block text-xs uppercase tracking-wide text-foreground-secondary"
						>
							Roll gradient
						</label>
						<span class="text-sm text-foreground-secondary">
							{vehicleInputs.desiredRollGradient.toFixed(decimals(0.01))}
						</span>
					</div>
					<RangeSliderInput
						min={0.02}
