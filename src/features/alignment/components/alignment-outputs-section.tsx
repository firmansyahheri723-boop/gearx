	...
	return (
		<div class="border border-border/50 bg-background/50">
			<SectionHeader
				...
				help={{
					description:
						"Predicted handling characteristics based on your alignment settings. These are game-specific approximations for CarX Street physics.",
					position: "bottom",
				}}
			/>
			<div class="p-4 space-y-4">
				<div class="grid grid-cols-2 md:grid-cols-4 gap-4">
					<MetricCard
						...
						badge={
							props.outputs.understeerTendency > 20
								? "UNDERSTEER"
								: props.outputs.understeerTendency < -20
									? "OVERSTEER"
									: undefined
