		...
		<div class="flex flex-col gap-4">
			<div class="flex items-center justify-between">
				...
				<button
					...
					class="border border-emerald-700 hover:border-emerald-600 bg-emerald-900/30 hover:bg-emerald-900/50 text-emerald-400 hover:text-emerald-300 px-4 py-2 text-xs uppercase tracking-wider transition-colors cursor-pointer"
				>
				...
				<div class="max-h-80 overflow-y-auto">
					<table class="w-full text-xs font-mono">
						<thead class="sticky top-0 bg-surface">
							<tr>
								<th class="px-3 py-2 text-left text-[10px] text-muted font-normal uppercase tracking-wider border-b border-border">
									#
								</th>
								<th class="px-3 py-2 text-right text-[10px] text-muted font-normal uppercase tracking-wider border-b border-border">
									Torque (Nm)
								</th>
								<th class="px-3 py-2 text-right text-[10px] text-muted font-normal uppercase tracking-wider border-b border-border">
									RPM
			...
			<div class="text-[10px] text-muted uppercase tracking-wider">
				This data will replace your current torque curve values. Click "Apply"
				to confirm.
			</div>
		</div>
	);
