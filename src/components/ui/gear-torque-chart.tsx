import { VisAxis, VisLine, VisScatter, VisXYContainer } from "@unovis/solid";
import { CurveType } from "@unovis/ts";
import { Component, createMemo, For, Show } from "solid-js";
import { GEAR_COLORS, TRACTION_LIMIT_COLOR } from "@/constants/colors";
import type { SpeedRpmPoint } from "@/features/gearbox/types";
		...
		>
			...
			<Show when={!props.compact && props.gearNames.length > 0}>
				<div class="flex flex-wrap justify-center gap-4 mt-3 px-4">
					...
					<div class="flex items-center gap-1.5">
						<span class="w-3 h-0.5" style={{ background: peakCurveColor() }} />
