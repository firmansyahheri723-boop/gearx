...
const QUICK_PROMPTS: QuickPrompt[] = [
  { label: 'Explain suspension', prompt: 'Explain the suspension calculator and what each setting does in CarX Street.' },
  { label: 'Gear ratios help', prompt: 'How do I optimize my gear ratios for maximum acceleration in CarX Street?' },
  { label: 'Tune for drift', prompt: 'What suspension settings should I use for drifting in CarX Street?' },
  { label: 'Aero setup', prompt: 'Explain how aerodynamics affect car performance and what values I should use.' },
];
