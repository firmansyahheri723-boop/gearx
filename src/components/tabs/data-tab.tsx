        ...
        <div class="flex-shrink-0 border-r-2 border-slate-700 bg-slate-950 z-10">
          <table class="text-xs">
            <thead>
              ...
              {/* Column header row */}
              <tr>
                <th class="px-3 py-2.5 text-xs font-semibold tracking-wider uppercase bg-yellow-500/10 text-yellow-400 border-b border-yellow-500/30 text-left whitespace-nowrap min-w-[180px]">
                  Name
                </th>
              </tr>
            </thead>
              ...
              <tr>
                <For each={props.scrollableColumns}>
                  {(col) => {
                    ...
                    return (
                      <th
                        class={`px-3 py-2.5 text-xs font-semibold tracking-wider uppercase border-b border-r text-center whitespace-nowrap min-w-[80px] ${
                          group ? `${group.color} ${group.headerColor}` : 'bg-slate-900 text-slate-400 border-slate-700/50'
                        }`}
                      >
                        {col.header}
                      </th>
